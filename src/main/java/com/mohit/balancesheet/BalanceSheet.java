...
public class BalanceSheet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			/*id from BalanceSheetController*/			
...
//		out.println("height: 55vh;");
		...
		out.println("<br>");
		out.println("<input type='text' name='bsDateFrom' id='dDateFrom' placeholder='yyyy-mm-dd' required='required'>");
		out.println("<input type='text' name='sbTo' id='dTo' placeholder='yyyy-mm-dd' required='required'>");
		...
		out.println("<tr>");
		out.println("<th style='text-align: center; color: black; font-size: 25px; background-color: grey;'>Incomes</th>");
		out.println("<th style='text-align: center; color: black; font-size: 25px; background-color: grey;'>Expences</th>");
		out.println("</tr>");
		...
		out.println("<table border='0' class='left-daybook-table' style='width: 100%; height: 100%; margin: 0; line-height:22px;'>");
		...
		ArrayList<IncomesBean> al2 = id.findAllByUi(userId);
		...
		out.println("<table border='0' class='left-daybook-table' style='width: 100%; height: 100%; line-height:22px;'>");
		...
		ArrayList<ExpencesBean> al1 = ed.findAllByUi(userId);
		...
		out.println("<tr>");
		out.println("<th colspan='2' style='text-align: center; color: black; font-size: 25px; background-color: grey;'>Gross Amount   :   " + totalAmount + "</th>");
		out.println("</tr>");
