...
public class CashBookController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String dateFrom = request.getParameter("cbDateFrom");
		String dateTo = request.getParameter("cbTo");
		...
		System.out.println("userid cb cont: " + userId);
		
		double totalAmount = 0.00;
		int sn = 1;
		CashBookDAO cd = new CashBookDAO();
		ArrayList<CashBookBean> al = cd.findCbByFTDate(dateFrom, dateTo, userId);
